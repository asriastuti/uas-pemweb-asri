...
@-webkit-keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}@keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}.chartjs-render-monitor{-webkit-animation:chartjs-render-animation 0.001s;animation:chartjs-render-animation 0.001s;}</style></head>
  ...
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="https://getbootstrap.com/docs/4.3/examples/dashboard/#">~ Buku Kita ~</a>
      ...
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            ...
            <a class="nav-link" href="<?php echo site_url('dashboardUser'); ?>">
          ...
          <li class="nav-item">
            ...
            <a class="nav-link" href="<?php echo site_url('dashboardUser/books'); ?>">
