        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo anchor('book/edit/'.$book_item['idbuku'], 'Edit', 'Edit Buku'); ?> | <?php echo anchor('book/delete/'.$book_item['idbuku'], 'Delete', 'Hapus Buku'); ?> | <?php echo anchor('book/view/'.$book_item['idbuku'], 'View', 'View'); ?></td>
            </tr>
            <?php endforeach; ?>
          </tbody>
          <tfoot>
